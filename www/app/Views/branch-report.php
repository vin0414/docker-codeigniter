...
<html lang="en" >
    <!--begin::Head-->
    <head>
        <title>ARP - Branch Reports</title>
        <meta charset="utf-8"/>
                    ...
                    <div class="app-header-secondary-menu-main d-flex flex-grow-lg-1 align-items-end pt-3 pt-lg-2 px-3 px-lg-0 w-auto overflow-auto flex-nowrap">
                        <div class="app-container  container-fluid ">
                            ...
                            >        
                                ...
                                <!--begin:Menu item-->
                                <div  class="menu-item " ><!--begin:Menu link-->
                                    <a class="menu-link active"  href="<?=site_url('branch-report')?>"><span  class="menu-title" >Branch Report</span></a>
                                    <!--end:Menu link-->
                                </div><!--end:Menu item-->
                                <!--begin:Menu item-->
                                <div  class="menu-item" ><!--begin:Menu content-->
                            ...
                            >        
                                ...
                                <div  class="menu-item" >
                                    ...
                                    <a class="menu-link active"  href="<?=site_url('dashboard')?>">
                                        ...
                                        <span class="menu-title" >Branch Reports</span>
                                    </a><!--end:Menu link-->
                                </div><!--end:Menu item-->		
                                <!--begin:Menu item-->
                                <div  class="menu-item" >
                        ...
                        <div  class="menu-sub menu-sub-accordion menu-state-gray-900 menu-fit open" >
                            <form method="GET" class="form w-100" id="frmFilter">
                                <div class="fv-row mb-4">
                                    ...
                                    <select class="form-select mb-2" data-control="select2" data-hide-search="true" data-placeholder="Select Region" name="region">
                                        <option value=""></option>
                                    </select>
                                    <!--end::Select2-->
                                </div>
