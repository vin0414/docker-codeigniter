                    ...
                    <div class="app-header-secondary-menu-main d-flex flex-grow-lg-1 align-items-end pt-3 pt-lg-2 px-3 px-lg-0 w-auto overflow-auto flex-nowrap">
                        <div class="app-container  container-fluid ">
                            ...
                            >        
                                ...
                                <!--begin:Menu item-->
                                <div  class="menu-item " ><!--begin:Menu link-->
                                    <a class="menu-link active"  href="javascript:void(0);"><span  class="menu-title" >Edit Branch</span></a>
                                    <!--end:Menu link-->
                                </div><!--end:Menu item-->
                                <!--begin:Menu item-->
            ...
            <div class="d-flex flex-column flex-column-fluid">
                    ...
                    <div id="kt_app_toolbar_container" class="app-container  container-fluid d-flex align-items-stretch ">
                        ...
                        <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                            ...
                            <div class="d-flex align-items-center gap-2 gap-lg-3">
                                <a href="<?=site_url('branches')?>" class="btn btn-sm btn-flex btn-primary">
                ...
                <div id="kt_app_content" class="app-content  flex-column-fluid " >
                    <div id="kt_app_content_container" class="app-container container-fluid ">
                        <form id="frmBranch" method="POST" class="form w-100">
                            <div class="card card-flush py-4">
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <input type="hidden" name="zone" value="<?=$zone['zoneID']?>"/>
                                    <input type="hidden" name="region" value="<?=$region['regionID']?>"/>
                                    <div class="d-flex flex-wrap gap-5 fv-row mb-8">
                                        <div class="fv-row w-100 flex-md-root">
                                            <label class="required form-label">Zone</label>
                                            <input type="text" value="<?=$zone['Name']?>" class="form-control bg-transparent" required/> 
                                        </div>
                                        <div class="fv-row w-100 flex-md-root">
                                            <label class="required form-label">Region</label>
                                            <input type="text" value="<?=$region['RegionName']?>" class="form-control bg-transparent" required/> 
                                        </div>
                                    </div>
                                    <div class="d-flex flex-wrap gap-5 fv-row mb-8">
                                        <div class="fv-row w-100 flex-md-root">
                                            <label class="required form-label">Code</label>
                                            <input type="text" name="code" value="<?=$branch['BranchCode']?>" class="form-control bg-transparent" required/> 
                                        </div>
                                        <div class="fv-row w-100 flex-md-root">
                                            <label class="required form-label">Branch Name</label>
                                            <input type="text" name="branchName" value="<?=$branch['BranchName']?>" class="form-control bg-transparent" required/> 
                                        </div>
                                        <div class="fv-row w-100 flex-md-root">
                                            <label class="required form-label">Type of Branch</label>
                                            <select class="form-select mb-2" data-control="select2" name="branchType" required>
                                                <option value=""></option>
                                                <option <?php if($branch['BranchType']=="Branch") echo 'selected="selected"'; ?> value="Branch">Branch</option>
                                                <option <?php if($branch['BranchType']=="Jewellers") echo 'selected="selected"'; ?> value="Jewellers">Jewellers</option>
                                            </select> 
                                        </div>
                                    </div>
                                    <div class="fv-row mb-8">
                                        <!--begin::Email-->
                                        <label class="required form-label">Branch Status</label>
                                        <select class="form-select mb-2" data-control="select2" name="status" required>
                                            <option value=""></option>
                                            <option <?php if($branch['Status']==1) echo 'selected="selected"'; ?> value="1">Active</option>
                                            <option <?php if($branch['Status']==0) echo 'selected="selected"'; ?> value="0">Inactive</option>
                                        </select>
                                        <!--end::Email-->
                                    </div>
                                    <div class="fv-row mb-8">
...
<!--end::App-->		
	    ...
	    <!--end::Javascript-->
        <script>
            $('#frmBranch').on('submit',function(e)
            {
                e.preventDefault();
                ...
                $.ajax({
                    url:"<?=site_url('update-branch')?>",method:"POST",data:data,
