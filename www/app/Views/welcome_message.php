    ...
    <div class="d-flex flex-lg-row-fluid">
        ...
        <div class="d-flex flex-column flex-center pb-0 pb-lg-10 p-10 w-100"> 
            ...
            <div class="text-gray-600 fs-base text-center fw-semibold">
                Comprehensive CMS(Content Management System) for generating Accounting Reports<br/>
                for almost 3000 branches nationwide. Real-time computations and monitoring of
                financial statements.<br/>
                <a href="" class="link-primary">Visit Official Page</a>
            </div>
            <!--end::Text-->
        </div>
        <!--end::Content-->
