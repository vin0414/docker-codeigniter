                    ...
                    <div class="app-header-secondary-menu-main d-flex flex-grow-lg-1 align-items-end pt-3 pt-lg-2 px-3 px-lg-0 w-auto overflow-auto flex-nowrap">
                        <div class="app-container  container-fluid ">
                            ...
                            >        
                                ...
                                <!--begin:Menu item-->
                                <div  class="menu-item " ><!--begin:Menu link-->
                                    <a class="menu-link active"  href="<?=site_url('zones')?>"><span  class="menu-title" >All Regions</span></a>
                                    <!--end:Menu link-->
                                </div><!--end:Menu item-->
                                <!--begin:Menu item-->
                            ...
                            <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-400px mb-7 me-lg-10">
                                <div class="card card-flush py-4">
                                    <div class="card-header">
                                        <div class="card-title">New Region</div>
                                    </div>
                                    <div class="card-body">
                                        <form method="POST" class="form w-100" id="frmRegion">
                                            <div class="fv-row mb-4">
                                                <!--begin::Select2-->
                                                <label class="required form-label">Zone</label>
                                                <select class="form-select mb-2" data-control="select2" data-hide-search="true" name="zone" required>
                                            ...
                                            <div class="fv-row mb-8">
                                                ...
                                                <input type="text" placeholder="Enter here" name="region_name" autocomplete="off" class="form-control bg-transparent" required/> 
                                                <!--end::Email-->
                                            </div>
                                            <div class="fv-row mb-8">
                                        ...
                                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="table">
                                            <thead>
                                                <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                                                    <th class="min-w-100px">Zones</th>
                                                    <th class="min-w-200px">Regions</th>
                                                    <th class="min-w-70px">Date Created</th>
                                                    <th class="min-w-70px">Actions</th>
                                                </tr>
                                            </thead>
                                            <tbody class="fw-semibold text-gray-600" id="tblregion">
...
<!--end::App-->		
        ...
        <script>
            ...
            function fetch()
            {
                $('#tblregion').html("<tr><td colspan='4'><center>Loading...</center></td></tr>");
                $.ajax({
                    url:"<?=site_url('fetch-regions')?>",method:"GET",
                    success:function(response)
                    {
                        if(response==="")
                        {
                            $('#tblregion').html("<tr><td colspan='4'><center>No Record(s)</center></td></tr>");
                        }
                        else
                        {
                            $('#tblregion').html(response);
                        }
                    }
                });
            }
            ...
            $('#search').keyup(function(){
                $('#tblregion').html("<tr><td colspan='4'><center>Loading...</center></td></tr>");
                $.ajax({
                    url:"<?=site_url('search-regions')?>",method:"GET",
            ...
            $('#frmRegion').on('submit',function(e)
            {
                ...
                $.ajax({
                    url:"<?=site_url('save-region')?>",method:"POST",
            ...
            {
                var confirmation = confirm("Do you want to remove this selected region?");
                if(confirmation)
                {
                    $.ajax({
                        url:"<?=site_url('delete-region')?>",method:"POST",
