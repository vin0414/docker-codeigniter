                    ...
                    <div class="app-header-secondary-menu-main d-flex flex-grow-lg-1 align-items-end pt-3 pt-lg-2 px-3 px-lg-0 w-auto overflow-auto flex-nowrap">
                        <div class="app-container  container-fluid ">
                            ...
                            >        
                                ...
                                <!--begin:Menu item-->
                                <div  class="menu-item " ><!--begin:Menu link-->
                                    <a class="menu-link active"  href="<?=site_url('zones')?>"><span  class="menu-title" >All Branches</span></a>
                                    <!--end:Menu link-->
                                </div><!--end:Menu item-->
                                <!--begin:Menu item-->
                        ...
                        <div class="d-flex flex-column flex-lg-row gap-2">
                            <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-400px mb-7 me-lg-10">
                                <div class="card card-flush py-4">
                                    ...
                                    <div class="card-body">
                                        <form method="POST" class="form w-100" id="frmBranch">
                                            <div class="fv-row mb-4">
                                                <!--begin::Select2-->
                                                <label class="required form-label">Zone</label>
                                                <select class="form-select mb-2" data-control="select2" name="zone" id="zone" required>
                                                    <option value="">Choose</option>
                                                    <?php foreach($zone as $row): ?>
                                                        <option value="<?php echo $row['zoneID'] ?>"><?php echo $row['Name'] ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                                <!--end::Select2-->
                                            </div>
                                            <div class="fv-row mb-4">
                                                ...
                                                <select class="form-select mb-2" data-control="select2" name="region" id="region" required>
                                                    <option value="">Choose</option>
                                                </select>
                                                <!--end::Select2-->
                                            </div>
                                            <div class="fv-row mb-8">
                                                ...
                                                <input type="text" placeholder="ML ****" name="branch_name" autocomplete="off" class="form-control bg-transparent" required/> 
                                                <!--end::Email-->
                                            </div>
                                            <div class="d-flex flex-wrap gap-5 fv-row mb-8">
                                                <div class="fv-row w-100 flex-md-root">
                                                    <label class="required form-label">Branch Code</label>
                                                    <input type="text" placeholder="000" name="code" maxlength="3" minlength="3" autocomplete="off" class="form-control bg-transparent" required/> 
                                                </div>
                                                <div class="fv-row w-100 flex-md-root">
                                                    <label class="required form-label">Branch Type</label>
                                        ...
                                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="table">
                                            <thead>
                                                <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                                                    <th class="min-w-50px">Zones</th>
                                                    <th class="min-w-100px">Regions</th>
                                                    <th class="min-w-100px">Branches</th>
                                            ...
                                            <tbody class="fw-semibold text-gray-600" id="tblbranch">
...
<!--end::App-->		
        ...
        <script>
            ...
            function fetch()
            {
                $('#tblbranch').html("<tr><td colspan='7'><center>Loading...</center></td></tr>");
                $.ajax({
                    url:"<?=site_url('fetch-branches')?>",method:"GET",
                    success:function(response)
                    {
                        if(response==="")
                        {
                            $('#tblbranch').html("<tr><td colspan='7'><center>No Record(s)</center></td></tr>");
                        }
                        else
                        {
                            $('#tblbranch').html(response);
                        }
                    }
                });
            }
            ...
            $('#search').keyup(function(){
                $('#tblbranch').html("<tr><td colspan='7'><center>Loading...</center></td></tr>");
                $.ajax({
                    url:"<?=site_url('search-branches')?>",method:"GET",
            ...
            $('#zone').change(function(){
                ...
                $.ajax({
                    url:"<?=site_url('list-of-regions')?>",method:"GET",
                    data:{value:val},
                    success:function(response)
                    {
                        if(response==="")
            ...
            $('#frmBranch').on('submit',function(e)
            {
                ...
                $.ajax({
                    url:"<?=site_url('save-branch')?>",method:"POST",
            ...
            {
                var confirmation = confirm("Do you want to remove this selected branch?");
                if(confirmation)
                {
                    $.ajax({
                        url:"<?=site_url('delete-branch')?>",method:"POST",
